<?php
	...
	// INSERT EXTRAS HERE
        ...
        // EDIFICE CATEGORIES INPUT
                ...
                if (in_array('blog', string_to_tag_array(get_plugin_setting('allowed_object_types', 'edifice')))) {
                    $categories_input = elgg_view('edifice/forms/assign', array('current_category' => $current_category));
                }
